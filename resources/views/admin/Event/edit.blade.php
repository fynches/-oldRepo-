...
<div class="portlet light">
    ...
    <div class="form-group">
        <div class="col-md-6">
            ...
            {!! Form::select('image_type', array('Image','Video'), isset($event[0]['getEventMappingMdedia'][0]['image_type'])?$event[0]['getEventMappingMdedia'][0]['image_type']:0, array('class' => 'form-control uploadBanner')) !!}
        </div>
