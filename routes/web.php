...
Route::group(array('prefix' => 'admin', 'middlewareGroups' => 'auth', 'after' => 'auth'), function() {
	...
	//Betasignup
	Route::get('/user/getBetaData', 'Admin\UserController@getBetaData');
	...
	Route::get('/event/getData', 'Admin\EventController@getData');
	...
	//Tag
	Route::get('/tag/getData', 'Admin\TagController@getData');
	Route::get('/tag/delete/{id}', 'Admin\TagController@destroy'); 
	Route::get('delete_multiple_Tag/{id}', 'Admin\TagController@multiple_row_delete');
